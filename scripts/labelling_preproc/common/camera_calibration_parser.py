...
class Intrinsics:
    ...
    cx, cy: offsets (in pixels) fo the principal point
...
class CameraCalibrationParser:
    ...
    def get_intrinsics(self, camera_matrix: dict) -> Intrinsics:
        ...
        # Order data = [fx, 0, cx, 0, fy, cy, 0, 0, 1]
    ...
    def get_camera_calibration(self, camera_calibration_file: str) -> CameraCalibrationData:
        """
